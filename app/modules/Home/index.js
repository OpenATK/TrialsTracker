import noteAdded from './signals/noteAdded';
import noteSelected from './signals/noteSelected';
import noteRemoved from './signals/noteRemoved';
    ...
    for (var i = 1; i<4;i++) {
      ...
      if (i === 3) {
        ...
        note = {
          ...
          tags: [],
          fields: ['Smith40'],
          geojson: {"type":"FeatureCollection","properties":{"kind":"state","state":"IN"},"features":[
